...
echo ""
echo -e "npm needs elevated privileges to update dependencies in the background. To give it these elevated privileges, run \"sudo visudo\" and add the following line:\caleb ALL=(ALL) NOPASSWD: npm"
echo ""
