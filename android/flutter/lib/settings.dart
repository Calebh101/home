            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Setting(title: "Show Seconds in Clock", desc: "Show the current second in the digital clock.", text: (prefs.getBool("clockShowSeconds") ?? false) ? "Yes" : "No", action: () => editSetting(context: context, key: "clockShowSeconds", value: prefs.getBool("clockShowSeconds") ?? false, type: "bool")),
